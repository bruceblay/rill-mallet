...
int main(int argc, char** argv) {
  ...
  auto engine = std::unique_ptr<mallet::Engine>(new mallet::Engine(seed, family));
  std::vector<int16_t> pcm(size_t(seconds) * mallet::rate);
  ...
  put32(16); put16(1); put16(1); put32(mallet::rate); put32(mallet::rate * 2); put16(2); put16(16);
