...
SHOTS = {'asanoha': (0, 5, 210), 'uroko': (1, 42, 210), 'ring': (2, 3, 210),
         'kikko': (3, 17, 210), 'ripple': (4, 5, 210), 'bloom': (5, 99, 210),
         'snap': (6, 11, 210), 'moons': (7, 5, 210)}
...
with tempfile.TemporaryDirectory() as directory:
    ...
    for index, name in enumerate(['ring', 'snap', 'bloom', 'ripple', 'asanoha', 'uroko', 'kikko', 'moons']):
        row, column = divmod(index, 4)
        row_width = 4 * 480 + 3 * gap
